...
data WORK.cc_derived(keep=PROC_DTE AC_CODE RSME_FLG RATING_MODEL_CODE
                            CIF_TYP_CODE INTERNAL_RATING MKT_SUB_SEG CREDIT_SCORE_SOURCE &act_out);
    ...
    set LBFRS9.T_MTH_FRS9_CC_DTL(keep=PROC_DTE AC_CODE ORIGINAL_ACCOUNT_NUMBER
