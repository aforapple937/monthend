...
data WORK.mstr_derived(keep=PROC_DTE V_ACCOUNT_NUMBER CUSTOMER_ID MKT_SUB_SEG V_CUST_MKT_SUB_SEG &act_out);
    retain PROC_DTE V_ACCOUNT_NUMBER CUSTOMER_ID MKT_SUB_SEG V_CUST_MKT_SUB_SEG &act_out;
