...
| `LBFRS9.T_MTH_FRS9_LN_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `AC_CODE` = `AC_CODE` | 1:1 |
| `LBFRS9.T_MTH_FRS9_CC_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `AC_CODE` = `AC_CODE` | 1:1 |
| `LBFRS9.T_MTH_FRS9_OD_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `AC_CODE` = `AC_CODE` | 1:1 |
| `LBFRS9.T_MTH_FRS9_INVMT_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `AC_CODE` = `AC_CODE` | 1:1 |
| `LBFRS9.T_MTH_FRS9_GUARANTEE_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `AC_CODE` = `AC_CODE` | 1:1 |
