...
|---|---|---|---|
| `LBFRS9` | `T_MTH_FRS9_LN_DTL` | `PROC_DTE` + `AC_CODE` | |
| `LBFRS9` | `T_MTH_FRS9_CC_DTL` | `PROC_DTE` + `AC_CODE` | |
| `LBFRS9` | `T_MTH_FRS9_OD_DTL` | `PROC_DTE` + `AC_CODE` | |
| `LBFRS9` | `T_MTH_FRS9_INVMT_DTL` | `PROC_DTE` + `AC_CODE` | |
| `LBFRS9` | `T_MTH_FRS9_GUARANTEE_DTL` | `PROC_DTE` + `AC_CODE` | |
| `LBDWH` | `V_T_MTH_AC_DTL` | `PROC_DTE` + `AC_CODE` | |
| `LBFRS9` | `T_MTH_FRS9_RDL_AC_DTL` | `PROC_DTE` + `UNIQUE_ID_NO` | |
...
| `LBFRS9` | `T_MTH_RSME_CMPLX_PRD_WRK_TBL` | `PROC_DTE` + `CIF_NO` | |
| `LBFRS9` | `T_MTH_FRS9_AC_RATING_DTL` | `PROC_DTE` + `AC_CODE` + `ORGL_CR_RATING_FLG` | 2 rows/account: `Y` orig, `N` current |
| `LBFRS9` | `T_MTH_FRS9_RT_DTL` | `PROC_DTE` + `AC_CODE` + `RT_EFF_DTE` | |
...
| `LBFRS9.T_MTH_FRS9_LN_DTL` | `LBDWH.V_T_MTH_AC_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
| `LBFRS9.T_MTH_FRS9_CC_DTL` | `LBDWH.V_T_MTH_AC_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
| `LBFRS9.T_MTH_FRS9_OD_DTL` | `LBDWH.V_T_MTH_AC_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
| `LBFRS9.T_MTH_FRS9_INVMT_DTL` | `LBDWH.V_T_MTH_AC_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
| `LBFRS9.T_MTH_FRS9_GUARANTEE_DTL` | `LBDWH.V_T_MTH_AC_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
...
| `LBDWH.V_T_MTH_AC_DTL` | `LBFRS9.T_MTH_RSME_CMPLX_PRD_WRK_TBL` | `CIF_NO` = `CIF_NO` | many:1 |
...
| `LBFRS9.T_MTH_FRS9_LN_DTL` | `LBFRS9.T_MTH_FRS9_RT_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | 1:many |
...
| `LBFRS9.T_MTH_FRS9_LN_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
| `LBFRS9.T_MTH_FRS9_CC_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
| `LBFRS9.T_MTH_FRS9_OD_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
| `LBFRS9.T_MTH_FRS9_INVMT_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
| `LBFRS9.T_MTH_FRS9_GUARANTEE_DTL` | `LBDWH.T_DAL_BORR_AC_RATING_DTL` | `ORIGINAL_ACCOUNT_NUMBER` = `AC_CODE` | many:1 |
